...
class StudentRegister extends Component {
    ...
    submitRegisterForm = (e) => {
       ...
       this.props.history.replace('/all-company')
    }
          ...
          <form className="col s10" onSubmit={this.submitRegisterForm}>
            ...
            <div className="row">
                ...
                <div className="input-field col s6">
                    ...
                    <div className="input-field col s6">
                        <i className="material-icons prefix">location_city</i>
                        <input onChange={this.handleChange} value={this.state.city} id="city" type="text" className="validate" />
            ...
            <div className="row">
                <div className="col s12">
                    ...
                    <div className="input-field col s6">
                        ...
                        <input onChange={this.handleChange} value={this.state.dateOfBirth} id="dateOfBirth" type="date" className="validate" />
